                  ...
                  <div className="col-md-12">
                      ...
                      <div className="hl-faq-item">
                        ...
                        <div className="hl-faq-answer text-start">
                          <p>
                            ...
                            profiles, and apply for job opportunities posted by
                            employers.
                          </p>
                        </div>
                      </div>
                    ...
                    <div className="hl-faq-box">
                      <div className="hl-faq-item">
                        ...
                        <div className="hl-faq-answer text-start">
                          <p>
                            Any individual who is looking for a job, internship,
                            or career opportunity can register as a candidate on
                            Hirelinkinfo.com.
                          </p>
                        </div>
                      </div>
                      ...
                      <div className="hl-faq-item">
                        ...
                        <div className="hl-faq-answer text-start">
                          <p>
                            ...
                            signup/registration fee of ₹300 to create an account
                            and access candidate services.
                          </p>
                        </div>
                      </div>
                    </div>
                      ...
                      <div className="hl-faq-item">
                        ...
                        <div className="hl-faq-answer text-start">
                          <p>
                            ...
                            access other candidate-related features provided on
                            the platform.
                          </p>
                        </div>
                      </div>
                      ...
                      <div className="hl-faq-item">
                        ...
                        <div className="hl-faq-answer text-start">
                          <p>
                            ...
                            optional paid services are introduced in the future,
                            the details and charges will be clearly communicated
                            before purchase.
                          </p>
                        </div>
                      </div>
                    ...
                    <div className="hl-faq-box">
                      <div className="hl-faq-item">
                        <h3 className="hl-faq-question">
                          <i className="fa fa-question-circle"></i>
                          What happens if my payment is deducted but my account
                          is not activated?
                        </h3>
                        <div className="hl-faq-answer text-start">
                          <p>
                            In case of payment deduction without account
                            activation due to a technical issue, candidates can
                            contact support within 7 working days with payment
                            proof. Refunds or resolutions will be provided after
                            verification.
                          </p>
                        </div>
                      </div>
                      ...
                      <div className="hl-faq-item">
                        ...
                        <div className="hl-faq-answer text-start">
                          <p>
                            ...
                            duplicate payment issue, it will be processed within
                            7 to 10 working days to the original payment method.
                          </p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="hl-faq-box">
                      <div className="hl-faq-item">
                        ...
                        <div className="hl-faq-answer text-start">
                          <p>
                            Candidates can contact the support team through the
                            official support options available on
                            Hirelinkinfo.com.
                          </p>
                        </div>
                      </div>
                      ...
                      <div className="hl-faq-item">
                        ...
                        <div className="hl-faq-answer text-start">
                          <p>
                            ...
                            terminated if there is misuse of the platform, false
                            information, or violation of Terms & Conditions. No
                  ...
                  <div className="col-md-12">
                    ...
                    <div className="hl-faq-box">
                      <div className="hl-faq-item">
                        ...
                        <div className="hl-faq-answer text-start">
                          <p>
                            Any company, organization, consultant, or individual
                            recruiter looking to hire candidates can register as
                            an employer on Hirelinkinfo.com.
                          </p>
                        </div>
                      </div>
                    </div>
                      ...
                      <div className="hl-faq-item">
                        ...
                        <div className="hl-faq-answer text-start">
                          <p>
                            ...
                            non-refundable once the employer account is created
                      ...
                      <div className="hl-faq-item">
                        ...
                        <div className="hl-faq-answer text-start">
                          <p>
                            ...
                            postings, featured listings, subscription upgrades,
                            or other paid recruitment services. All charges will
                            be displayed before payment.
                          </p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="hl-faq-box">
                      <div className="hl-faq-item">
                        ...
                        <div className="hl-faq-answer text-start">
                          <p>
                            In case of payment deduction without account
                            activation due to a technical issue, employers must
                            contact support within 7 working days with valid
                            payment proof.
                          </p>
                        </div>
                      </div>
                    ...
                    <div className="hl-faq-box">
                      <div className="hl-faq-item">
                        ...
                        <div className="hl-faq-answer text-start">
                          <p>
                            If a refund is approved due to duplicate payment or
                            technical error, it will be processed within 7 to 10
                      ...
                      <div className="hl-faq-item">
                        ...
                        <div className="hl-faq-answer text-start">
                          <p>
                            ...
                            applications or profile access, subject to platform
                      ...
                      <div className="hl-faq-item">
                        ...
                        <div className="hl-faq-answer text-start">
                          <p>
                            ...
                            detected. No refund will be provided in such cases.
                          </p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="hl-faq-box">
                      <div className="hl-faq-item">
                        <h3 className="hl-faq-question">
                          <i className="fa fa-question-circle"></i>
                          Can Hirelinkinfo.com change employer fees or services?
                        </h3>
                        <div className="hl-faq-answer text-start">
                          <p>
                            Yes. Hirelinkinfo.com reserves the right to change
                            pricing, services, or policies at any time. Changes
                            will be effective upon publication on the website.
                          </p>
                        </div>
                      </div>
                    </div>
