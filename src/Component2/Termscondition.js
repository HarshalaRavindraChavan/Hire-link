  ...
  return (
    <>
      <div className="tc-body">
        <div className="tc-wrapper" style={{ backgroundImage: `url(${logo})` }}>
          <div className="tc-container">
            <h1 className="tc-title fw-bold">Terms & Conditions</h1>
            <h3 className="tc-heading">Objective</h3>
            <p className="tc-text">
            ...
            <h3 className="tc-heading">CONDITIONS OF USE</h3>
            <p className="tc-text">
            ...
            <p className="tc-text">
              ...
              cards, UPI,etc. Hirelink Infotech Pvt Ltd and its Affiliated
            ...
            <h3 className="tc-heading">SECURITY MEASURES</h3>
            <p className="tc-text">
            ...
            <h3 className="tc-heading">Payment</h3>
            <p className="tc-text">
